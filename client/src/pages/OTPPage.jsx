      ...
      <div className="w-full max-w-md fade-up">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <h2 className="text-2xl font-black text-gray-900 mb-2">Vérification</h2>
            <p className="text-gray-400 text-sm mb-1">Code envoyé à</p>
            <p className="text-[#1B4332] font-bold text-sm mb-6">{email}</p>
              ...
              {otp.map((digit, i) => (
                <input
                  ...
                  className={`w-12 h-14 text-center text-2xl font-black rounded-2xl border-2 transition-all focus:outline-none
                    ${digit ? "border-[#1B4332] bg-[#f0fdf4] text-[#1B4332]" : "border-gray-200 bg-gray-50 text-gray-900"}
